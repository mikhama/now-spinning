# playback-idle-screensaver Specification

## Purpose
Define the playback idle screensaver, its activation behavior, appearance, cover-derived palette, and font playground.
